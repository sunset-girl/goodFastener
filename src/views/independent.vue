     ...
     <topper></topper>
      ...
      <div class="center">
        <div class="center_top">
          ...
          <!-- <el-carousel :interval="3000" arrow="always" :height="imgHeight">
        ...
        <div class="center_cen">
          <div class="center_cen_left">
            <img src="./image/idependent1.png" alt="">
          </div>
         <div class="foot_right">
              <p>{{$t("message.Independent.I_1")}}</p>
              <p>{{$t("message.Independent.I_2")}}</p>
              <p>{{$t("message.Independent.I_3")}}</p>
              <span>{{$t("message.Independent.I_4")}}</span>
        </div>
        </div>
        <div class="clear"></div>
      </div>
...
export default {
  data() {
    return {
      // imgList: [
      //     {id: 0, idView: require('./image/new1.png')},
...
.center .center_cen .center_cen_right{
  float: left;
  margin:124px 0 0 184px;
}
.center .center_cen .center_cen_right rig{
  float: left;
}
.center_cen .center_cen_right div{
  width: 162px;
  height: 32px;
  text-align: center;
  font-size: 16px;

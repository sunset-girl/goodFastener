     ...
     <topper></topper>
      ...
      <div class="center">
        <div class="center_top">
          <img src="./image/banner_04_03.jpg" alt="">
        ...
        <div class="center_cen">
          <div class="center_cen_left">
            <img src="./image/certified1.png" alt="">
          </div>
         <div class="foot_right">
              <p>{{$t("message.Certified.C_1")}}</p>
              <p>{{$t("message.Certified.C_2")}}</p>
              <span>{{$t("message.Certified.C_3")}}</span>
        </div>
        </div>
        <div class="clear"></div>
      </div>
